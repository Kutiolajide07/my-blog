    ...
    <main className="max-w-4xl mx-auto px-6 py-12">
      <article className="space-y-8">
        ...
        <div>
          ...
          <div className="mt-6 bg-slate-100 dark:bg-slate-800 rounded-xl p-5">
            <strong>Topics:</strong> Claude Code • Skills • Subagents • MCP • Hooks • Permissions • Claude Memory • DevOps • Infrastructure as Code
          </div>
        </div>
        ...
        <section>
          ...
          <p>
            Week 2 of the DevOps Training with Agentic AI provided an excellent opportunity to explore how artificial intelligence can become an active participant in modern software engineering and infrastructure automation rather than simply serving as a conversational assistant.
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>AI is most effective when integrated into disciplined engineering workflows.</li>
            <li>Engineering judgement remains more important than automation alone.</li>
            <li>Security and governance must accompany every automated workflow.</li>
            <li>Real-world environments require adaptability beyond tutorial examples.</li>
            <li>Documenting implementation and troubleshooting accelerates continuous learning.</li>
          </ul>
        </section>
        ...
        <footer className="text-center text-gray-500 py-6">
          <h3 className="font-bold text-lg">Olajide Kuti</h3>
          <p>
            Cloud Engineer • Microsoft Azure • Microsoft 365 • Cloud Security • DevOps • AI-Assisted Engineering
          </p>
        </footer>
